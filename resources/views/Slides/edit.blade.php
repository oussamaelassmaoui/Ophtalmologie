        ...
        <section>
            <form action="{{ route('Slides.update', $Slide->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    class="form-control @error('text') is-invalid @enderror" required autofocus>{{ old('text', $Slide->text) }}</textarea>
                    @error('text')
                        <div class="text-danger">{{ $message }} </div>
                    @enderror
                ...
                <div class="d-grid my-2">
                    <button type="submit" class="btn btn-primary ">edit un Slide</button>
