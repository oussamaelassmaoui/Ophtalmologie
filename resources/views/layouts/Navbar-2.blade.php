...
<head>
    ...
    <link href="assets/css/style-Guide.css" rel="stylesheet">
    {{-- <link href="{{ asset('assets/css/style-avis.css') }}" rel="stylesheet"> --}}
...
<body class="background-image-Guide  antialiased">
            ...
            <div class="navbar">
                <nav class="header__menu">
                    <ul>
                        ...
                        <li>
                            <a href="{{ route('Clinique') }}">LA CLINIQUE</a>
                            <ul class="header__menu__dropdown">
                                <li class="active"><a href="{{ route('Clinique') }}">LA CLINIQUE</a></li>
                        ...
                        <li>
                            <a href="#">INFOS</a>
                            <ul class="header__menu__dropdown">
                                <li class="active"><a href="{{ route('Guide') }}">GUIDE DU PATIENT ET DU VISITEUR</a>
                                </li>
                        ...
                        <li>
                            <a href="#">ACTIVITÉS</a>
                            <ul class="header__menu__dropdown">
                                <li class="active"><a href="{{ route('Pôle-social') }}">PÔLE SOCIAL ET
                                        HUMANITAIRE</a></li>
                            </ul>
                        </li>
                    ...
                    <div class="row">
                        <div class="col">
                            ...
                            <a href="mailto:ophtalmologie.contact.clinique@gmail.com"> <i
                                    class="fa-solid fa-envelope"></i> ophtalmologie.contact.clinique@gmail.com</a><br>
                            <a
    ...
    {{-- END whatsapp --}}
    {{-- <a href="#" ><img src="{{ asset('assets/img/fleche-vers-le-haut.png') }}" alt="fleche-vers-le-haut" width="5%" height="5%"></a> --}}
