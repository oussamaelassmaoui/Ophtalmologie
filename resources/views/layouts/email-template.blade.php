...
table, td { color: #000000; } @media (max-width: 480px) { #u_content_text_1 .v-container-padding-padding { padding: 30px 10px 10px 20px !important; } #u_content_text_1 .v-font-size { font-size: 41px !important; } #u_content_text_1 .v-line-height { line-height: 90% !important; } #u_content_heading_3 .v-container-padding-padding { padding: 10px 10px 0px 30px !important; } #u_content_heading_3 .v-line-height { line-height: 130% !important; } #u_content_heading_5 .v-container-padding-padding { padding: 10px 10px 0px 30px !important; } #u_content_heading_5 .v-line-height { line-height: 130% !important; } #u_content_divider_1 .v-container-padding-padding { padding: 10px 20px 10px 30px !important; } #u_content_text_2 .v-container-padding-padding { padding: 20px 10px 30px 30px !important; } #u_content_heading_4 .v-container-padding-padding { padding: 30px 20px 10px !important; } #u_content_heading_4 .v-text-align { text-align: center !important; } #u_content_text_4 .v-container-padding-padding { padding: 0px 20px 10px !important; } #u_content_text_4 .v-text-align { text-align: center !important; } }
    </style>
...
<body class="clean-body u_body" style="margin: 0;padding: 0;-webkit-text-size-adjust: 100%;background-color: #636161;color: #000000">
  <!--[if IE]><div class="ie-container"><![endif]-->
  <!--[if mso]><div class="mso-container"><![endif]-->
  <table style="border-collapse: collapse;table-layout: fixed;border-spacing: 0;mso-table-lspace: 0pt;mso-table-rspace: 0pt;vertical-align: top;min-width: 320px;Margin: 0 auto;background-color: #636161;width:100%" cellpadding="0" cellspacing="0">
  <tbody>
  <tr style="vertical-align: top">
    <td style="word-break: break-word;border-collapse: collapse !important;vertical-align: top">
    <!--[if (mso)|(IE)]><table width="100%" cellpadding="0" cellspacing="0" border="0"><tr><td align="center" style="background-color: #636161;"><![endif]-->
...
<!--[if (mso)|(IE)]><td align="center" width="600" style="background-color: #ededed;width: 600px;padding: 0px;border-top: 0px solid transparent;border-left: 0px solid transparent;border-right: 0px solid transparent;border-bottom: 0px solid transparent;" valign="top"><![endif]-->
<div class="u-col u-col-100" style="max-width: 320px;min-width: 600px;display: table-cell;vertical-align: top;">
  <div style="background-color: #ededed;height: 100%;width: 100% !important;">
  <!--[if (!mso)&(!IE)]><!--><div style="box-sizing: border-box; height: 100%; padding: 0px;border-top: 0px solid transparent;border-left: 0px solid transparent;border-right: 0px solid transparent;border-bottom: 0px solid transparent;"><!--<![endif]-->
  
<table id="u_content_text_1" style="font-family:arial,helvetica,sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
  <tbody>
    <tr>
      <td class="v-container-padding-padding" style="overflow-wrap:break-word;word-break:break-word;padding:30px 10px 10px 35px;font-family:arial,helvetica,sans-serif;" align="left">
        
  <div class="v-text-align v-line-height v-font-size" style="font-size: 71px; line-height: 90%; text-align: left; word-wrap: break-word;">
    <p style="line-height: 90%;"><span style="line-height: 81.9px;" data-metadata="&lt;!--(figmeta)eyJmaWxlS2V5Ijoid1dSSml4azFPdjB4OFI2NkFYbHhTcCIsInBhc3RlSUQiOjU0MDMxMDI1OSwiZGF0YVR5cGUiOiJzY2VuZSJ9Cg==(/figmeta)--&gt;"></span><strong><span style="line-height: 81.9px;">Ophtalmologie<br /></span></strong></p>
  </div>
...
<!--[if (mso)|(IE)]><td align="center" width="600" style="background-color: #ededed;width: 600px;padding: 0px;border-top: 0px solid transparent;border-left: 0px solid transparent;border-right: 0px solid transparent;border-bottom: 0px solid transparent;border-radius: 0px;-webkit-border-radius: 0px; -moz-border-radius: 0px;" valign="top"><![endif]-->
<div class="u-col u-col-100" style="max-width: 320px;min-width: 600px;display: table-cell;vertical-align: top;">
  <div style="background-color: #ededed;height: 100%;width: 100% !important;border-radius: 0px;-webkit-border-radius: 0px; -moz-border-radius: 0px;">
...
<table id="u_content_heading_3" style="font-family:arial,helvetica,sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
  ...
  <!--[if mso]><table width="100%"><tr><td><![endif]-->
    <h1 class="v-text-align v-line-height v-font-size" style="margin: 0px; line-height: 130%; text-align: left; word-wrap: break-word; font-size: 27px; font-weight: 400;"><span><span>Bienvenue à l'Hôpital d'Ophtalmologie !</span></span></h1>
...
<table id="u_content_heading_5" style="font-family:arial,helvetica,sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
  ...
  <!--[if mso]><table width="100%"><tr><td><![endif]-->
    <h2 class="v-text-align v-line-height v-font-size" style="margin: 0px; line-height: 130%; text-align: left; word-wrap: break-word; font-family: andale mono,times; font-size: 20px; font-weight: 400;"><span>Cher(e) {!! $nom_complet !!},</span></h2>
  <!--[if mso]></td></tr></table><![endif]-->
...
<table id="u_content_text_2" style="font-family:arial,helvetica,sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
  ...
  <div class="v-text-align v-line-height v-font-size" style="font-size: 14px; line-height: 140%; text-align: left; word-wrap: break-word;">
    <p style="line-height: 140%;"><span data-metadata="&lt;!--(figmeta)eyJmaWxlS2V5Ijoid1dSSml4azFPdjB4OFI2NkFYbHhTcCIsInBhc3RlSUQiOjY0MDA2NTQ3NywiZGF0YVR5cGUiOiJzY2VuZSJ9Cg==(/figmeta)--&gt;" style="line-height: 19.6px;"></span>Nous sommes ravis de vous accueillir à l'Hôpital d'Ophtalmologie ! Nous sommes dévoués à offrir des soins de qualité exceptionnelle dans le domaine de la santé oculaire et à vous accompagner tout au long de votre parcours vers une vision optimale.<br />Notre équipe médicale expérimentée et dévouée s'engage à vous fournir les meilleurs soins possibles. Que ce soit pour des examens de routine, des traitements spécifiques ou des interventions chirurgicales, notre objectif principal est votre bien-être et la préservation de votre vision.<br />Nous comprenons l'importance cruciale de la vue dans votre vie quotidienne et nous sommes ici pour répondre à toutes vos questions, préoccupations et besoins. Votre confort et votre satisfaction sont au cœur de nos préoccupations.<br />N'hésitez pas à nous contacter pour toute demande d'information supplémentaire ou pour planifier un rendez-vous. Nous sommes là pour vous accompagner à chaque étape de votre parcours vers une vision claire et saine.<br />Nous sommes impatients de vous accueillir dans notre hôpital et de prendre soin de vous.<br />Cordialement,</p>
  </div>
...
<table id="u_content_text_4" style="font-family:arial,helvetica,sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
  ...
  <div class="v-text-align v-line-height v-font-size" style="font-size: 13px; color: #ffffff; line-height: 170%; text-align: left; word-wrap: break-word;">
    <p style="line-height: 170%;"><span data-metadata="&lt;!--(figmeta)eyJmaWxlS2V5IjoiMlBQSXNjNFd3Q2ZlU0tINFZVMlBXeiIsInBhc3RlSUQiOjE5NDM5MjkyMjcsImRhdGFUeXBlIjoic2NlbmUifQo=(/figmeta)--&gt;" style="line-height: 22.1px;"></span>C’est très important de prendre soin du patient, et le patient sera suivi, mais le temps est tel qu’il travaillera. Mais afin que vous voyiez d'où vient toute cette erreur.</p>
  </div>
